      ...
      <div className="about">
        <Container>
          <Row className="align-items-center">
            <Col xl={6} lg={6}>
              <div className="aboutThumbWrap d-sm-flex align-items-center justify-content-center justify-content-lg-end">
                ...
                <Col xl={6} lg={6} md={6} sm={6}>
                  <div className="aboutService">
                    <div className="aboutServiceIcon">
                      <span>
                        ...
                        >
                          ...
                          ></path>
                          <path
                            d="M5.4043 7.80469H9.06035V40.2076H5.4043V7.80469Z"
                            fill="#72C2E9"
                          ></path>
                          <path
                            d="M38.9414 7.80469H42.5957V40.207H38.9414V7.80469Z"
                            fill="#72C2E9"
                          ></path>
                          <path
                    ...
                    <div className="aboutServiceDescription">
                      <h3 className="aboutServiceTitle">Amazing Tour Plans</h3>
                      <p>
                  ...
                  <div className="aboutService">
                    <div className="aboutServiceIcon">
                      <span>
                        ...
                        >
                          ...
                          ></path>
                          <path
                            d="M15.9703 36.8734L2.3125 31.5488V47.4152H15.9703V36.8734Z"
                            fill="#F46275"
                          ></path>
                          <path
                            d="M2.3125 31.5488V47.4152H5.24219V32.691L2.3125 31.5488Z"
                            fill="#F43075"
                          ></path>
                          <path
                            d="M15.9688 36.8734L29.6268 31.5488V47.4152H15.9688V36.8734Z"
                            fill="#F46275"
                          ></path>
                          <path
                            d="M26.6973 32.691V47.4152H29.627V31.5488L26.6973 32.691Z"
                            fill="#F48875"
                          ></path>
                          <path
                          ...
                          ></path>
                          <path
                            d="M0.308594 40.4902H3.23828V46.2244H0.308594V40.4902Z"
                            fill="#F87023"
                          ></path>
                          <path
                          ...
                          ></path>
                          <path
                            d="M28.7012 40.4902H31.6309V46.2244H28.7012V40.4902Z"
                            fill="#F8D323"
                          ></path>
                          <path
                            d="M30.166 0.304688H49.6947V24.9984H30.166V0.304688Z"
                            fill="#CECECE"
                          ></path>
                          <path
                            d="M46.7637 0.304688H49.6934V24.9984H46.7637V0.304688Z"
                            fill="#E2E2E2"
                          ></path>
                          <path
                    ...
                    <div className="aboutServiceDescription">
                      <h3 className="aboutServiceTitle">Best Travel Guide</h3>
                      <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do..
                      </p>

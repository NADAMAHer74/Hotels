  ...
  return (
    <div>
        <header>
                ...
                <div className="container d-flex justify-content-between align-items-center flex-sm-row">
                    <div className="dropdownCompanyInfo d-xl-none d-lg-none  d-inline-block">
                        ...
                        <ul className="contactMenu collapseList">
                            <li className="p-3">
                                <a className="text-decoration-none d-flex align-items-center" href="#">
                                    <i className="fa-solid fa-phone-volume"></i>
                                    (000) 967-237-96
                                </a>
                            </li>
                    ...
                    <div className="contactInfo">
                        <a href="#"><i className="fa-solid fa-phone-volume"></i><span>(000)
                                967-237-96</span></a>
                        <a href="#"><i className="fa-regular fa-envelope"></i><span>toursinfo@gmail.com</span></a>
                        <a href="#"> <i className="fa-solid fa-location-dot"></i><span>290 Grand Avenue
            ...
            <nav className="navbar sticky-top navbar-expand-lg bg-white " data-bs-theme="dark">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav ms-auto">
                            ...
                            <li className="nav-item dropdown me-4">
                                <Link className="nav-link dropdown-toggle text-dark" to="#" id="navbarDropdownTours" role="button"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    Tours
                                </Link>
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdownTours">
                                    <li><Link className="dropdown-item" to="/tourgrid">Tour</Link></li>
                                    <li><Link className="dropdown-item" to="/tourdetail">Tour Detail</Link></li>
                                </ul>
                            </li>
                            <li className="nav-item me-4">
                            ...
                            <li className="nav-item dropdown me-4">
                                <a className="nav-link dropdown-toggle text-dark" href="#" id="navbarDropdownBlog" role="button"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    Blog
                                </a>
